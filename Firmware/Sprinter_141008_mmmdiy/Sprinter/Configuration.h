...
//***********
 //Date: 141007
//#define _AXIS_STEP_PER_UNIT {1600, 1600, 1600, 1600}
//const int X_MAX_LENGTH = 70;
//const int Y_MAX_LENGTH = 70;
//const int Z_MAX_LENGTH = 40;
//#define _MAX_FEEDRATE {300, 300, 2, 45}       // (mm/sec)    
//#define _HOMING_FEEDRATE {300,300,300}      // (mm/min) !!
//#define MAX_STEP_FREQUENCY 1000 // Max step frequency
   //#define AUTO_TEMP_MIN -1 //was oriningally 205
...
// X, Y, Z, E steps per unit - using 200 s/rev 2mm pitch nut-core stepper and PMC syringe extruder
#define _AXIS_STEP_PER_UNIT {1600, 1600, 1600, 1600}
